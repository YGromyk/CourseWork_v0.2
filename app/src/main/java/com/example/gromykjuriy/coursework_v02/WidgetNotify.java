...
import res.drawable.*;
/**
 * Helper class for showing and canceling widget notify
 * notifications.
 * <p>
...
public class WidgetNotify {
     ...
     */
    private static final String NOTIFICATION_TAG = "WidgetNotify";
     ...
     * presentation of widget notify notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final String title = res.getString(
                R.string.widget_notify_notification_title_template, exampleString);
        final String text = res.getString(
                R.string.widget_notify_notification_placeholder_text_template, exampleString);
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_widget_notify)
